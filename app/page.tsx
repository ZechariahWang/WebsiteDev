    ...
    <main className="min-h-screen">
      ...
      <section className="flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        <div className="flex gap-4">
          <Link 
            href="https://drive.google.com/file/d/1JWIvP2figULp_VLJo94ZI9UldrHgyTzt/view?usp=sharing" 
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <p className="text-muted-foreground">
                Hi, I'm Zech! I'm currently a 1B Mechatronics Engineering student at the University of Waterloo. This term, I worked at Conavi Medical as a Software Engineering Intern in Toronto, Ontario!
              </p>
              <p className="text-muted-foreground">
